...
export const NodeConfigPanel: React.FC<{ nodeExecutionData?: any }> = ({ nodeExecutionData }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
            ...
            >
                {/* Header with Red Theme for Gmail */}
                <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-white rounded-t-xl">
                    <div className="flex items-center gap-3">
                         <div className={`p-2 rounded-lg ${definition?.category === 'Google' ? 'bg-red-100 text-red-600' : 'bg-slate-100 text-slate-600'}`}>
                ...
                <div className="p-8 overflow-y-auto custom-scrollbar flex-1">
                    <div className="mb-8">
                        ...
                        <input 
                            ...
                            className="w-full bg-slate-50 border border-slate-300 rounded-lg p-3 text-sm font-medium text-slate-900 focus:outline-none focus:ring-2 focus:ring-red-500 transition-all"
                ...
                <div className="p-6 border-t border-slate-100 bg-white rounded-b-xl flex justify-between items-center">
                    ...
                    <div className="flex gap-3">
                         <button 
                             ...
                             className={`px-4 py-2.5 font-medium rounded-lg transition-all flex items-center gap-2 ${isExecuting ? 'bg-slate-100 text-slate-400' : 'bg-red-50 text-red-600 hover:bg-red-100'}`}
                        >
