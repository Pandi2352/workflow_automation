        ...
        <div className="relative group min-w-[180px]">
            ...
            <div className="absolute top-1/2 left-0 -translate-x-full -translate-y-1/2 pr-4 flex items-center opacity-0 group-hover:opacity-100 transition-all duration-200 z-50 pointer-events-none group-hover:pointer-events-auto">
                <button 
                    ...
                    className="bg-[#EF4444] hover:bg-[#DC2626] text-white px-2 py-2 rounded-md font-semibold text-[10px] flex items-center gap-2 transition-all transform hover:-translate-y-0.5 cursor-pointer"
                >
            ...
            <Handle
                ...
                className="!w-2 !h-4 !bg-slate-400 !border-2 !border-white !rounded-sm transition-all hover:!bg-red-500 -right-[7px]"
            />
        </div>
    );
});
