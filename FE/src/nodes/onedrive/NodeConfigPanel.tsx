...
// --- Generic Configuration Component (Copied for standalone capability) ---
                    ...
                    <div className="relative flex gap-2">
                        <div className="relative flex-1">
                            <select
                                ...
                                className="w-full bg-slate-50 border border-slate-300 rounded-lg p-2.5 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none"
                            >
            ...
            return (
                <div key={key} className="mb-5">
                    ...
                    <select
                        ...
                        className="w-full bg-slate-50 border border-slate-300 rounded-lg p-2.5 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                    >
...
export const NodeConfigPanel: React.FC<{ nodeExecutionData?: any }> = ({ nodeExecutionData }) => {
    ...
    // Handle Microsoft Auth Pop-up Message (Global Listener for Panel)
    useEffect(() => {
        const handleMessage = (event: MessageEvent) => {
            // Reusing GOOGLE_AUTH_SUCCESS type if backward compatibility is needed, or we can check provider.
            // Backend sends: { type: 'GOOGLE_AUTH_SUCCESS', credentialId, provider: 'microsoft' }
            ...
            >
                ...
                <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-white rounded-t-xl">
                    <div className="flex items-center gap-3">
                         <div className={`p-2 rounded-lg ${definition?.category === 'Microsoft' ? 'bg-blue-100 text-blue-600' : 'bg-slate-100 text-slate-600'}`}>
                ...
                <div className="p-8 overflow-y-auto custom-scrollbar flex-1">
                    <div className="mb-8">
                        ...
                        <input 
                            ...
                            className="w-full bg-slate-50 border border-slate-300 rounded-lg p-3 text-sm font-medium text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                ...
                <div className="p-6 border-t border-slate-100 bg-white rounded-b-xl flex justify-between items-center">
                    ...
                    <div className="flex gap-3">
                         <button 
                             ...
                             className={`px-4 py-2.5 font-medium rounded-lg transition-all flex items-center gap-2 ${isExecuting ? 'bg-slate-100 text-slate-400' : 'bg-blue-50 text-blue-600 hover:bg-blue-100'}`}
                        >
